...
app.use(cookieSession({
  name: 'session',
  keys: ['d96a5bad00f0f5bbfa7fa03ba42bab02a229ebd69', '09b75924af0e502cd1fad019ac6efdade87971019']
}));
app.use(function (req, res, next) {
  ...
  req.getCurrentUser = function () {
    if (req.loggedIn) {
      return database.getUserById(this.session.userId).then(function (user) {
